const titulos = [
	...
	{
		nombre: 'COORDINADORES 1ra',
		value: 'coordinadores_1ra',
		readOnly: false,
		minWidth: 180,
		type: 'text',
		format: 'normal',
	...
	{
		nombre: 'COORDINADORES 2da',
		value: 'coordinadores_2da',
		readOnly: false,
		minWidth: 180,
		type: 'text',
		format: 'normal',
	...
	{
		nombre: 'COORDINADORES 3ra',
		value: 'coordinadores_3ra',
		readOnly: false,
		minWidth: 180,
		type: 'text',
		format: 'normal',
	...
	{
		nombre: 'AVANCE FISICO 1',
		value: 'avance_fisico_1',
		readOnly: false,
		minWidth: 100,
		type: 'text',
		format: 'porcentaje',
	...
	{
		nombre: 'AVANCE FISICO 2',
		value: 'avance_fisico_2',
		readOnly: false,
		minWidth: 60,
		type: 'text',
		format: 'porcentaje',
	...
	{
		nombre: 'PLAZO DE EJECUCION',
		value: 'plazo_ejecucion',
		readOnly: false,
		minWidth: 100,
		type: 'date',
		format: 'normal',
	...
	},
	{
		...
		value: 'observaciones_fecha_control_plazos',
		readOnly: false,
		minWidth: 250,
		type: 'text',
		format: 'normal',
	...
	{
		nombre: 'DOCUMENTACION DE REINICIO DE OBRA',
	...
	{
		nombre: 'MONTO TOTAL SOLES',
		value: 'monto_total_soles',
		readOnly: false,
		minWidth: 150,
		type: 'text',
		format: 'money',
	...
	{
		nombre: 'CONFORMIDAD BIENES',
		value: 'conformidad_bienes',
		readOnly: false,
		minWidth: 150,
		type: 'text',
		format: 'money',
	...
	{
		nombre: 'CANTIDAD CEMENTO',
		value: 'cantidad_cemento',
		readOnly: false,
		minWidth: 80,
		type: 'text',
		format: 'money',
...
const estructuraTitulos = {
	nivel_1: [
		...
		{
			nombre: 'INFORMACION PRESUPUESTAL',
			colspan: 9,
			rowspan: 1,
			minWidth: 80,
		},
		...
		{
			nombre: 'REQUERIMIENTOS Y CONFORMIDADES',
			colspan: 6,
			rowspan: 1,
			minWidth: 80,
		},
		...
		{
			nombre: 'LINEA DE BASE – EJECUCIÓN FISICA – ENERO 2023',
			colspan: 1,
			rowspan: 2,
			minWidth: 150,
		},
		{
			nombre: 'META DE AVANCE FISICO AL 2023 %',
			colspan: 2,
			rowspan: 1,
			minWidth: 80,
		},
	...
	nivel_2: [
		...
		{
			nombre: 'PROBLEMÁTICA (REINICIO, REQUERIMIENTOS, CONFORMIDADES, ETC)',
			minWidth: 300,
		},
		...
		{
			nombre: 'RESTRICCIONES PARA NO LLEGAR A LA META DEL AVANCE FISICO 2023',
			minWidth: 400,
		},
	],
};
