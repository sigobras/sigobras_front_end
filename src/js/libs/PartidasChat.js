...
function Comentarios({
	...
	async function fetchComentario() {
		...
		comentarioTotales();
		scrollToBottom();
		recargaComponenteMensajes(idComponente);
	}
	...
	function socketIni() {
		socket.on('partidas_comentarios_novistos_get-' + idPartida, () => {
	...
	function socketIniChat() {
		socket.on('partidas_comentarios_get-' + idPartida, () => {
							...
							<div className='input-group input-group-chat'>
								...
								<div className='input-group-append'>
									<span className='input-group-text input-group-text-chat'>
										<FaPaperPlane onClick={() => saveComentario()} />
									</span>
								</div>
							</div>
						</div>
