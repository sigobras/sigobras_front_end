...
export default () => {
	...
	async function fetchProvincias() {
		const res = await axios.get(`${UrlServer}/v1/unidadEjecutora/public`);
	...
	async function fetchSectores() {
		const res = await axios.get(`${UrlServer}/v1/sectores/public`, {
			params: {
	...
	async function fetchObras() {
		const res = await axios.get(`${UrlServer}/v1/obras/public`, {
			params: {
				id_unidadEjecutora: ProvinciaSeleccionada,
