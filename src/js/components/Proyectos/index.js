			...
			<table className='table'>
				<thead>
					...
					>
						...
						<th>
							Informacion General del PIP y Responsables de Elab. Exp. Tec.{' '}
						</th>
						<th>Datos del Plan de Trabajo </th>
						<th>Plazo de Ejecucion </th>
						<th>Avance Fisico </th>
						<th colSpan='4'>Ejecucion Presupuestal</th>
					</tr>
				</thead>
				<tbody>
...
function PlanTrabajo({ proyectos_id }) {
	...
	// recursos
	const [ProyectoPlanTrabajoRecursos, setProyectoPlanTrabajoRecursos] =
		useState([]);
			...
			<div>
				<table style={{ width: '100%' }}>
					<tr>
						...
						<th>
							{Redondea(
								ProyectoPlanTrabajoRecursos.reduce(
									(acc, item) => acc + Number(item.presupuesto),
									0,
								),
							)}{' '}
						</th>
...
function AvanceFisico({ proyectos_id }) {
	...
	return [
		...
		>
			...
			<th>Entregable</th>
			<th>
				{ProyectoAvanceFisico.reduce((acc, item) => acc + item.porcentaje, 0)} %
			</th>
		</tr>,
...
function EjecucionPresupuestal({ proyectos_id }) {
	...
	const [EjecucionPresupuestalAnterior, setEjecucionPresupuestalAnterior] =
		useState({});
	...
	const [EjecucionPresupuestalActual, setEjecucionPresupuestalActual] =
		useState({});
	...
	return (
		<td>
			...
			<tr>
				...
				<th>{Redondea(EjecucionPresupuestalAnterior.presupuesto)}</th>
				<th
					style={{
						color: '#17a2b8',
					}}
				...
				<th>{Redondea(EjecucionPresupuestalActual.presupuesto)}</th>
			</tr>
			<tr>
				<th
					style={{
			...
			<tr>
				...
				<td>{Redondea(EjecucionPresupuestalAnterior.pim)}</td>
				<th
					style={{
						color: '#17a2b8',
					}}
				...
				<td>{Redondea(EjecucionPresupuestalActual.pim)}</td>
			</tr>
			<tr>
				<th
					style={{
				...
				<td>{Redondea(EjecucionPresupuestalAnterior.ejecutado)}</td>
				<th
					style={{
						color: '#17a2b8',
					}}
				...
				<td>{Redondea(EjecucionPresupuestalActual.devengado)}</td>
			</tr>
			<tr>
				<th />
				<th />
				...
				<th>
					{Redondea(
						EjecucionPresupuestalActual.pim -
							EjecucionPresupuestalActual.devengado,
					)}
				</th>
			</tr>
			<tr>
