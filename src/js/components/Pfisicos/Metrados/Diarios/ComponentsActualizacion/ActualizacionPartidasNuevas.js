...
class ActualizacionPartidasNuevas extends Component {
    ...
    render() {
        const { SMSActualizacionMM, DataComponentes, DataPartidas, DataActividades, DataMayorMetrado, debounceTimeout, descripcion, smsValidaMetrado, collapse,  nombreComponente, OpcionMostrarMM } = this.state

        return (
            <div>
              {
                SMSActualizacionMM === true? <div className="text-danger text-center">No hay partidas Nuevas</div>:
                  <Card>
                    <Nav tabs>
...
export default ActualizacionPartidasNuevas;
