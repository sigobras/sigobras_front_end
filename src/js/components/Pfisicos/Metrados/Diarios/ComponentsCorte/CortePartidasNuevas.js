...
import { InputGroupAddon, InputGroupText, CustomInput,  InputGroup, Spinner, Nav, NavItem, NavLink, Card, CardHeader, CardBody, Button, Modal, ModalHeader, ModalBody, ModalFooter, Collapse, InputGroupButtonDropdown, Input, DropdownToggle, DropdownMenu, DropdownItem } from 'reactstrap';
...
class CortePartidasNuevas extends Component {
    ...
    EnviarMayorMetrado(e){
      ...
      var { DataPartidas, DataActividades, nombre, veces, largo, ancho, alto, parcialMM, OpcionMostrarMM, partidas_id_partida, indexPartida } = this.state
    ...
    render() {
        var { DataComponentes, MesajePartidaNuevaMM, DataPartidas, DataActividades, DataMayorMetrado, debounceTimeout, descripcion, smsValidaMetrado, collapse,  nombreComponente, OpcionMostrarMM } = this.state

        return (
            <div>
              { MesajePartidaNuevaMM === true? <div className="text-center text-danger"> NO HAY DATOS QUE MOSTRAR</div>:
                <Card>
                  <Nav tabs>
...
export default CortePartidasNuevas;
