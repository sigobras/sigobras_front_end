...
function HistorialObservaciones() {
    ...
    async function getCantidadComentarios(tipo) {
        ...
        var req_comentariosNoVistos = await axios.post(`${UrlServer}/getDificultadesComentariosNoVistosFicha`,
            {
                "id_acceso": sessionStorage.getItem('idacceso'),
    ...
    function onchangeDificultades(value, name) {
        ...
        if (name == "fecha_inicio" || name == "fecha_final" || name == "duracion" || name == "duracion_tipo") {
    ...
    async function saveDificultad() {
        ...
        if (confirm("Los datos ingresados se guardaran, esta seguro?")) {
            const request = await axios.post(`${UrlServer}/postDificultades`,
                newDificultad
            )
        ...
        <div>
                                ...
                                <tr key={"1." + i} >
                                    ...
                                    <td>
                                        ...
                                        >
                                            ...
                                            {DificultadComentariosNoVistos[i] && DificultadComentariosNoVistos[i].mensajes ?
                                                <div style={{
                                                    background: "red",
                                                    borderRadius: "50%",
                                                    textAlign: "center",
            ...
            <Modal isOpen={modalDificultad} toggle={toggleDificultad}>
                ...
                <ModalFooter>
                    ...
                    <Button color="secondary" onClick={toggleDificultad}>Cancel</Button>
                </ModalFooter>
            </Modal>
            {/* MODAL COMENTARIOS */}
