...
export default () => {
  ...
  async function fetchSemanas(mes) {
    ...
    console.log("fetchSemanas", res);
    if (Array.isArray(res.data)) setSemanas(res.data);
  }
  ...
  async function fetchSemanaFechas(fecha_inicial, fecha_final) {
    console.log("getHistorialSemanalFechas recarga");
  ...
  async function getHistorialSemanalDias(id_componente, fecha) {
    console.log("/getHistorialSemanalDias");
    ...
    <div>
      <Nav tabs>
        ...
        {Meses.map((item, i) => (
          <NavItem key={i}>
            <NavLink
              ...
              onClick={() => {
                onChangeMesSeleccionado(item.mes);
              }}
            >
        ...
        {MesSeleccionado > 0 && (
          <Button
            onClick={() => {
              onChangeToggleHistorialSemanal();
            }}
            //  outline
            ...
            {Semanas.map((item, i) => (
              <NavItem key={i}>
                <NavLink
                  ...
                  className={classnames({
                    active: item.semana == SemanaSeleccionada,
                  })}
                >
                  S-{item.semana}
                </NavLink>
      ...
      <CardBody className="p-2" style={{ overflowX: "auto" }}>
        {MesSeleccionado > 0 ? (
          !toggleHistorialSemanal ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <div className="float-right">
                    S/.{" "}
                    {Redondea(ComponenteSeleccionado.componente_total_soles)}{" "}
                    {" 〰 "}
                    {Redondea(
                      ComponenteSeleccionado.componente_total_porcentaje
                    )}{" "}
                    %
                  </div>
                </CardHeader>
                      ...
                      {Fechas.map((item, i) => (
                        <fieldset key={i} className="mt-2">
                          <legend
                            className="prioridad"
                            onClick={() =>
                              onChangeFechasSeleccionada(item.fecha)
                            }
                          >
                            <b>FECHA: </b>
                          ...
                          <fieldset key={i} className="mt-2">
                            <div className="d-flex">
                              ...
                              >
                                ...
                                <b>
                                  {" "}
                                  {Redondea(item.fecha_total_porcentaje)} %
                                </b>
                                <Spinner
                                  size="sm"
                                  color="primary"
                            ...
                            <Collapse
                              isOpen={SemanaFechaSeleccionada == item.fecha}
                            >
                              <div className="table-responsive">
                                {SemanasComponentes.map((item2, i2) => [
                                  ...
                                  >
                                    ...
                                    >
                                      S/.{" "}
                                      {Redondea(item2.componente_total_soles)}{" "}
                                      {" 〰 "}
                                      {Redondea(
                                        item2.componente_total_porcentaje
                                      )}{" "}
                                      %
                                    </div>
                                  </div>,
                                      ...
                                      {item2.diasData &&
                                        item2.diasData.map((item3, i3) => (
                                          <tr key={i3}>
                                            ...
                                            <td>
                                              {item3.descripcion_actividad}
                                            </td>
                                            <td>
                                              {Redondea(item3.rendimiento)}
                                            </td>
                                            <td>
                      ...
                      rows.push(
                        <td>
                          ...
                          {avance_total > 0
                            ? "(" +
                              Redondea(
                                (avance_total / presupuesto_total) * 100
                              ) +
                              "%)"
                            : ""}
                        </td>
