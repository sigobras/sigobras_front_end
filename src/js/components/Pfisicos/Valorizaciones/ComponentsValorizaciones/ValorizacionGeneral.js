...
class ValorizacionGeneral extends Component {
  ...
  reqAnios() {
    // let isLoading = true;
    axios
      .post(`${UrlServer}${this.props.Ruta.Anios}`, {
      ...
      .then(async (res) => {
        ...
        if (res.data !== "vacio") {
          ...
          await this.setState({
            ...
            DataComponentesApi:
              res.data[UltimoAnio].periodos[UltimoMes].componentes,
  ...
  reqMeses(anio) {
    axios
      .post(`${UrlServer}${this.props.Ruta.Mes}`, {
        id_ficha: sessionStorage.getItem("idobra"),
        anyo: anio,
      })
      .then(async (res) => {
        ...
        this.reqResumen(
          res.data[UltimoMes].fecha_inicial,
          res.data[UltimoMes].fecha_final
        );
      })
      .catch((err) => {
  ...
  reqResumen(FechaInicial, FechaFinal) {
    ...
    axios
      .post(`${UrlServer}${this.props.Ruta.ResumenComp}`, {
        id_ficha: sessionStorage.getItem("idobra"),
  ...
  reqComponentes(FechaInicial, FechaFinal) {
    axios
      .post(`${UrlServer}${this.props.Ruta.Componentes}`, {
        id_ficha: sessionStorage.getItem("idobra"),
        fecha_inicial: FechaInicial,
        fecha_final: FechaFinal,
      })
  ...
  reqPartidas(IdComponente, FechaInicio, FechaFinal) {
    ...
    axios
      .post(`${UrlServer}${this.props.Ruta.Partidas}`, {
      ...
      <div>
          ...
          >
            ...
            <DropdownMenu>
              {DataAniosApi.map((anio, IndexAnio) => (
                <DropdownItem
                  key={IndexAnio}
                  onClick={() => this.SelectAnio(anio.anyo)}
                >
                  {anio.anyo}
                </DropdownItem>
              ))}
            ...
            <NavItem key={IndexMes}>
              <NavLink
                className={classnames({
                  active: activeTabMes === IndexMes.toString(),
                })}
                onClick={() =>
                  this.TabMeses(
                    IndexMes.toString(),
        ...
        <Nav tabs>
          <NavItem>
            <NavLink
              className={classnames({
                active: activeTabComponente === "resumen",
              })}
              onClick={() => {
                this.TabComponentes("resumen", "", "RESUMEN DE VALORIZACIÓN");
              }}
            >
              RESUMEN
            </NavLink>
          ...
          {DataComponentesApi.map((Comp, IComp) => (
            <NavItem key={IComp}>
              <NavLink
                className={classnames({
                  active: activeTabComponente === IComp.toString(),
                })}
                onClick={() => {
                  this.TabComponentes(
                    IComp.toString(),
          ...
          <CardBody>
            {activeTabComponente === "resumen" ? (
              <div className="table-responsive">
                <Table
                  className="table table-bordered small table-sm mb-0"
                  hover
                >
                  ...
                  <tbody>
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <input
                            ...
                            disabled={
                              this.state.activatorinput == index
                                ? ""
                                : "disabled"
                            }
                          />
                        ...
                        <td>
                          <button
                            ...
                            onClick={(event) =>
                              this.guardar_costo_indirecto(index)
                            }
                          >
                            <FaSave size={10} />
                          </button>
                    ...
                    <tr className="resplandPartida font-weight-bolder">
                      ...
                      <td>
                        ...
                        {(() => {
                          ...
                          for (
                            let index = 0;
                            index < this.state.costos_indirectos.length;
                            index++
                          ) {
                    ...
                    <tr>
                      ...
                      <td>
                        <button
                          className="btn btn-primary"
                          onClick={(event) => this.agregar_costo_indirecto()}
                        >
              ...
              <div className="table-responsive">
                <Table
                  className="table table-bordered table-sm small mb-0"
                  hover
                >
                  ...
                  <tbody>
                    {DataPartidasApi.partidas === undefined ? (
                      <tr>
                        <td colSpan="17">cargando</td>
                      </tr>
                    ) : (
                    ...
                    <tr className="resplandPartida">
                      ...
                      <td colSpan="2">
                        S/. {Redondea1(DataPartidasApi.valor_actual)}
                      </td>
