          ...
          <table className="table table-bordered table-hover">
            <thead className="resplandPartida">
              <tr className="text-center">
                ...
                <th>
                  S/. {Redondea(ResumenComponentesTotales.valor_anterior)}
                </th>
                <th>
          ...
          <table className="table table-bordered table-sm small mb-0" hover>
            <thead className="text-center resplandPartida">
              <tr>
                ...
                <th colSpan="2">
                  S/. {Redondea(PartidasTotales.valor_anterior)}
                </th>
                <th>{Redondea(PartidasTotales.porcentaje_anterior)} %</th>

                <th colSpan="2">
                  S/. {Redondea(PartidasTotales.valor_actual)}
                </th>
            ...
            <tbody>
              {Partidas.map((item) => (
                ...
                >
                  ...
                  <td>{Redondea(item.valor_anterior)}</td>
                  <td>
                    {Redondea((item.metrado_anterior / item.metrado) * 100)}
                  </td>

                  <td className="bg-mm">{Redondea(item.metrado_actual)}</td>
                  <td className="bg-mm">{Redondea(item.valor_actual)}</td>
                  <td>
                    {Redondea((item.metrado_actual / item.metrado) * 100)}
                  </td>

                  <td>
                    {Redondea(item.metrado_anterior + item.metrado_actual)}
                  </td>
                  <td>{Redondea(item.valor_anterior + item.valor_actual)}</td>
                  <td>
                    {Redondea(
