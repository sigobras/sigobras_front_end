...
import { TabContent, TabPane, Nav, NavItem, NavLink, Card, CardHeader, CardBody, Row, Col, UncontrolledPopover, PopoverBody, Collapse} from 'reactstrap';
...
class General extends Component {
    ...
    render() {
        const { activeTab, activeTabComponet, DataValorizacion, collapse, llamarComponentePartidaNueva } = this.state
        return ( 
            
            <div>
                <Card className="mt-2">
                    <CardHeader onClick={e=>this.CollapseCard(1)} data-event={1} >1. VALORIZACION {collapse === 1?'➖':'➕'}</CardHeader>
