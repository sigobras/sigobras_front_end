...
export default forwardRef(({ id_partida }, ref) => {
    ...
    async function fectchAvancePartida() {
        ...
        setAvancePartidaPorcentaje(Redondea1(request.data.avance_metrado / request.data.metrado * 100))
    }
        ...
        <div>
            ...
            >
                <div
                    style={{
                        ...
                        height: '100%',
                        background: AvancePartidaPorcentaje > 85 ? '#a4fb01'
                            : AvancePartidaPorcentaje > 30 ? '#0080ff'
                                : '#ff2e00',
            ...
            <div className="clearfix">
                <span className="float-left text-info">
                    Saldo: {Redondea(AvancePartida.metrado - AvancePartida.avance_metrado)}
                </span>
