...
export default () => {
	...
	async function cargarFuentesFinanciamiento() {
		const res = await axios.get(`${UrlServer}/v1/fuentesFinancieamiento`, {
			params: {
				id_ficha: sessionStorage.getItem('idobra'),
	...
	async function cargarFuentesFinanciamientoLista() {
		const res = await axios.get(`${UrlServer}/v1/fuentesFinancieamiento/list`, {
			params: {
				id_ficha: sessionStorage.getItem('idobra'),
				anyo: AnyoSeleccionado,
			},
	...
	async function agregarFuenteFinanciamiento() {
		...
		const res2 = await axios.put(`${UrlServer}/v1/fuentesFinancieamiento`, {
	...
	async function handleInputChange(index, e) {
		const res = await axios.put(`${UrlServer}/v1/fuentesFinancieamiento`, {
