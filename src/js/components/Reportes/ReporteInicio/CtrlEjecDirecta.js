...
class CtrlEjecDirecta extends Component {
	...
	render() {
		return (
			<div>
				<li className='lii'>
					<a href='#' onClick={this.resumenVal}>
						<FaFilePdf className='text-danger' /> CONTROL DE EJECUCION DE OBRAS
