...
class AvCompDiagGant extends Component {
	...
	printDocument() {
		...
		const res1 = pdf.autoTableHtmlToJson(document.getElementById('tabgant1'));
		const res2 = pdf.autoTableHtmlToJson(document.getElementById('tabgant2'));
		const res3 = pdf.autoTableHtmlToJson(document.getElementById('tabgant3'));
		const res4 = pdf.autoTableHtmlToJson(document.getElementById('tabgant4'));
	...
	render() {
		return (
			<div>
				<div>
					<li className='lii'>
						<a href='#' onClick={this.printDocument}>
					...
					<table id='tabgant1' className='table table-bordered'>
						<tbody>
							...
							<tr>
								<td>OBRA:</td>
								<td>
									"MEJORAMIENTO DE LOS SERVICIOS DE EDUCACIÓN INICIAL I.E.I. N°
									597 DEL CENTRO POBLADO DE PALCA,
								</td>
							</tr>
							<tr>
								<td>PERIODO:</td>
