  ...
  async function ResEstructarData() {
    ...
    ResumenComponentes.forEach((item, i) => {
      DataRestructurado.table.body.push(
        [
          ...
          {
            text: `${Redondea(item.valor_actual / item.presupuesto * 100)}` + " %",
            style: "TableValInforme",
            alignment: "right",
          },
          {
          ...
          {
            text: Redondea((item.valor_anterior + item.valor_actual) / item.presupuesto * 100) + " %",
            style: "tableBody",
            alignment: "right",
          },
          {
            text: Redondea(item.presupuesto - item.valor_anterior - item.valor_actual),
            style: "tableBody",
            alignment: "right",
          },
          {
            text: Redondea((item.presupuesto - item.valor_anterior - item.valor_actual) / item.presupuesto * 100) + " %",
            style: "tableBody",
            alignment: "right",
            margin: [0, 0, 4, 0]
    ...
    CostosIndirectos.forEach((item, j) => {
      DataRestructurado.table.body.push(
        [
          ...
          {
            text: Redondea(item.monto * parseFloat(ResumenComponentesTotales.porcentaje_anterior).toFixed(2) / 100),
            style: "tableFecha",
            alignment: "right",
          },
          {
          ...
          {
            text: Redondea(item.monto * parseFloat(ResumenComponentesTotales.porcentaje_actual).toFixed(2) / 100),
            style: "tableFecha",
            alignment: "right",
          },
          {
          ...
          {
            text: Redondea(item.monto * parseFloat(ResumenComponentesTotales.porcentaje_total).toFixed(2) / 100),
            style: "tableFecha",
            alignment: "right",
          },
          {
          ...
          {
            text: Redondea(item.monto * parseFloat(ResumenComponentesTotales.porcentaje_saldo).toFixed(2) / 100),
            style: "tableFecha",
            alignment: "right",
          },
          {
    ...
    DataRestructurado.table.body.push(
      [
        ...
        {
          text: "S/. " + Redondea(ResumenComponentesTotales.presupuesto + CostosIndirectosTotales.presupuesto),
          style: "TableTotalesInforme",
          alignment: "center",
        },
        {
          text: "S/. " + Redondea(ResumenComponentesTotales.valor_anterior + CostosIndirectosTotales.valor_anterior),
          style: "TableTotalesInforme",
          alignment: "center",
        },
        {
        ...
        {
          text: "S/. " + Redondea(ResumenComponentesTotales.valor_actual + CostosIndirectosTotales.valor_actual),
          style: "TableTotalesInforme",
          alignment: "center",
        },
        {
        ...
        {
          text: "S/. " + Redondea(ResumenComponentesTotales.valor_total + CostosIndirectosTotales.valor_total),
          style: "TableTotalesInforme",
          alignment: "center",
        },
        {
        ...
        {
          text: "S/. " + Redondea(ResumenComponentesTotales.valor_saldo + CostosIndirectosTotales.valor_saldo),
          style: "TableTotalesInforme",
          alignment: "center",
        },
        {
    ...
    var DataEncabezado = await encabezadoInforme(PeriodoSeleccionado.fecha_inicial, PeriodoSeleccionado.fecha_final)
  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} >
        <ModalHeader toggle={toggle}>3.- RESUMEN DE LA VALORIZACIÓN PRINCIPAL DE LA OBRA PRESUPUESTO BASE</ModalHeader>
        <ModalBody>
          <Row>
            <Col sm="2">
              <fieldset>
