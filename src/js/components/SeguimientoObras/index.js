                    ...
                    <tr >
                        ...
                        >
                            {(() => {
                                ...
                                return (
                                    [
                                        <div>{fechas1.fecha_inicial}</div>,
                                        <div>{fechas1.fecha_final}</div>,
                                        <div>{fechas2.fecha_inicial}</div>,
                                        <div>{fechas2.fecha_final}</div>
                                    ]
                                )
                            })()
                            }
