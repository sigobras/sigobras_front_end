...
export default () => {
	...
	async function cargarAnyos() {
		const res = await axios.get(`${UrlServer}/v1/partidasImagenes/anyos`, {
			params: {
	...
	async function cargarMeses() {
		const res = await axios.get(`${UrlServer}/v1/partidasImagenes/meses`, {
			params: {
				id_ficha: sessionStorage.getItem('idobra'),
	...
	async function cargarComponentes() {
		const res = await axios.get(
			`${UrlServer}/v1/partidasImagenes/Componentes`,
			{
				params: {
					id_ficha: sessionStorage.getItem('idobra'),
					anyo: AnyoSeleccionado,
	...
	async function cargarPartidas() {
		const res = await axios.get(`${UrlServer}/v1/partidasImagenes`, {
			params: {
				id_ficha: sessionStorage.getItem('idobra'),
				anyo: AnyoSeleccionado,
				mes: MesSeleccionado,
