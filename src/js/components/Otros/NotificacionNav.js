...
export default () => {
	...
	async function fetchNotificaciones() {
		if (
			...
			const res = await axios.get(`${UrlServer}/FichasNotificaciones`, {
				params: {
	...
	async function fetchNotificacionesCantidad() {
		const res = await axios.get(`${UrlServer}/FichasNotificaciones_cantidad`, {
			params: {
				id_acceso: sessionStorage.getItem('idacceso'),
				id_ficha: sessionStorage.getItem('idobra'),
			},
	...
	async function putFichasNotificaciones() {
		const res = await axios.put(`${UrlServer}/FichasNotificaciones`, {
			id_acceso: sessionStorage.getItem('idacceso'),
			id_ficha: sessionStorage.getItem('idobra'),
		});
		// fetchNotificacionesCantidad();
